...
Route::post('question', 'App\Http\Controllers\Api\AboutController@post_question');
...
Route::get('singlePropety', 'App\Http\Controllers\Api\PropertYController@singlePropety')->name('singlePropety');
...
Route::get('filter', 'App\Http\Controllers\Api\HomeController@filter');
