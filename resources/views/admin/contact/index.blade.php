        ...
        <tbody>
            @foreach ($data as $key => $value)
                <tr>
                    ...
                    <td nowrap="nowrap">
                        <a href="{{ route('show.contact', $value->id) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm" title="@lang('general.locales.show')">
                            <span class="svg-icon svg-icon-primary svg-icon-2x">
                                <i class="fa fa-eye"></i>
                            </span>
                        </a>

                        <a href="{{ route('contact.show-reply', $value->id) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm"
