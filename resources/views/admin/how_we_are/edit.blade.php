...
@section('module_name', trans('general.aside.how_we_are'))
@section('page_type', trans('general.edit'))
@section('title') @lang('general.aside.how_we_are') @endsection
@section('store_route', route('how_we_are.update', $data))
