...
@section('index_route', route('teams.index'))
@section('store_route', route('teams.store'))
...
@section('fields_content')
                ...
                @foreach (config('translatable.locales') as $key => $locale)
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}"
                        ...
                        <div class="form-group">
                            <label>@lang('teams.title') - @lang('general.' . $locale)<span class="text-danger"> * </span></label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="flaticon-edit"></i></span>
                                </div>
                                <input type="text" name="{{ $locale . '[title]' }}" placeholder="@lang('teams.title')"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="{{ $locale . '[description]' }}" placeholder="@lang('teams.description')"
    ...
    <div class="card card-custom">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="url" name="twiter" placeholder="@lang('settings.twitter')"
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="url" name="instgram" placeholder="@lang('settings.instagram')"
        ...
        <div class="card-footer">
            ...
            <a href="{{ route('teams.index') }}" class="btn btn-light-success font-weight-bold">@lang('general.cancel')</a>
        </div>
    </div>
@endsection
