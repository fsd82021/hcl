...
@section('store_route', route('teams.update', $data))
                ...
                @foreach (config('translatable.locales') as $key => $locale)
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}"
                        ...
                        <div class="form-group">
                            <label>@lang('teams.title') - @lang('general.' . $locale)<span class="text-danger"> *
                                </span></label>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="{{ $locale . '[description]' }}" id="{{ $locale . '[description]' }}"
                                    placeholder="@lang('categories.description')"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="url" name="instgram" placeholder="@lang('settings.instagram')"
                                    class="form-control  pl-5 min-h-40px @error($locale . '.instgram') is-invalid @enderror"
                                    value="{{ old('instgram', $data->instgram) }}">
                            </div>
                        </div>
                    </di-v>
                </div>
