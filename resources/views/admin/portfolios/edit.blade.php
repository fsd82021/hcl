...
@section('store_route', route('portfolios.update', $data))
                ...
                @foreach (config('translatable.locales') as $key => $locale)
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}"
                        ...
                        <div class="form-group">
                            <label>@lang('portfolios.title') - @lang('general.' . $locale)<span class="text-danger"> *
                                </span></label>
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="form-group">
                        ...
                        <select class="form-control selectpicker @error('category_id') is-invalid @enderror"
                            name="category_id" title="@lang('properties.category_name')">
