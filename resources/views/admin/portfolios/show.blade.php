                    ...
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-7 bg-light p-5 rounded h-100">
                                    <div class="card-title">
                                        <h5 class="font-weight-bolder text-dark">@lang('portfolios.title'):</h5>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-7 bg-light p-5 rounded h-100">
                                    <div class="card-title">
                                        <h5 class="font-weight-bolder text-dark">@lang('portfolios.description'):</h5>
                                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            @if ($data->main_image !== null)
                                ...
                                <br>
                                <img style="width: 200px;height:200px" src="{{ asset($data->main_image) }}">
                            @endif
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                                <label class="col-form-label d-block">@lang('properties.category_name')</label>
                                <br>
