...
@section('module_name', trans('general.aside.chalange'))
@section('page_type', trans('general.edit'))
@section('title') @lang('general.aside.chalange') @endsection
@section('store_route', route('start_page.update', $data))
        ...
        <div class="card card-custom">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>@lang('general.aside.pages.video')<span class="text-danger"> * </span></label>
                            <div class="input-group">
