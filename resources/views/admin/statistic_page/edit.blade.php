...
@section('module_name', trans('general.aside.statistic_page'))
@section('page_type', trans('general.edit'))
@section('title') @lang('general.aside.statistic_page') @endsection
@section('store_route', route('statistic_page.update', $data))
