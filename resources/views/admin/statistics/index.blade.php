...
@section('module_name') @lang('statistics.statistics') @endsection
@section('page_type') @lang('general.index') @endsection
@section('title') @lang('statistics.statistics') @endsection
@section('create_route', route('statistics.create'))
        ...
        <tbody>
            @foreach ($data as $key => $value)
                <tr>
                    ...
                    <td nowrap="nowrap">
                        @include('admin.components.table-control', ['name'=>'statistics', 'value'=>$value])
