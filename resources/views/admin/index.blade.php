        ...
        <div class="col-xl-4">
            <div class="card card-custom card-stretch gutter-b wave wave-primary wave-animate-slow">
                <div class="card-body">
                    ...
                    <span class="card-title font-weight-bolder text-dark-75 font-size-h1 mb-0 mt-6 d-block"> {{ $blogs_count }} </span>
                    <span class="font-weight-bold font-size-sm">المقالات</span>
                </div>
            </div>
        </div>
