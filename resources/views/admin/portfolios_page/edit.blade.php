...
@section('module_name', trans('general.aside.portfolios_page'))
@section('page_type', trans('general.edit'))
@section('title') @lang('general.aside.portfolios_page') @endsection
@section('store_route', route('portfolios_page.update', $data))
