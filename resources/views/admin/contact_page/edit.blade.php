...
@section('module_name', trans('general.aside.contact_page'))
@section('page_type', trans('general.edit'))
@section('title') @lang('general.aside.contact_page') @endsection
@section('store_route', route('contact_page.update', $data))
