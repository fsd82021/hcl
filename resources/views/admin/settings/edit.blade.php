                    ...
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="{{ $locale . '[website_title]' }}"
                                    placeholder="@lang('settings.website_title')"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="{{ $locale . '[meta_title]' }}" placeholder="@lang('settings.meta_title')"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="{{ $locale . '[meta_keywords]' }}"
                                    placeholder="@lang('settings.meta_keywords')"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="{{ $locale . '[address]' }}" placeholder="@lang('settings.address')"
                        ...
                        <div class="form-group">
                            <label>@lang('settings.working_hours') - @lang('general.' . $locale)<span class="text-danger"> * </span></label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="flaticon-edit"></i></span>
                                </div>
                                <input type="text" name="{{ $locale . '[working_hours]' }}"
                                    placeholder="@lang('settings.working_hours')"
                                    class="form-control pl-5 min-h-40px @error($locale . '.working_hours') is-invalid @enderror"
                                    value="{{ old($locale . '.working_hours', $data->translate($locale)->working_hours) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label>@lang('settings.meta_description') - @lang('general.' . $locale)<span class="text-danger"> * </span></label>
                            <textarea name="{{ $locale . '[meta_description]' }}" @error($locale . '.meta_description') is-invalid @enderror
                        ...
                        <div class="col form-group">
                            ...
                            <textarea class="form-control @error($locale . '.footer_description') is-invalid @enderror " type="text"
                                name="{{ $locale . '[footer_description]' }}" rows="4"
                                id="{{ $locale }}.editor1">{{ old($locale . '.footer_description', $data->translate($locale)->footer_description) }} </textarea>
                            <script>
    ...
    <div class="card card-custom">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="url" name="facebook" placeholder="@lang('settings.facebook')"
                                class="form-control  pl-5 min-h-40px @error($locale . '.facebook') is-invalid @enderror"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="url" name="twitter" placeholder="@lang('settings.twitter')"
                                class="form-control  pl-5 min-h-40px @error($locale . '.twitter') is-invalid @enderror"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="url" name="instagram" placeholder="@lang('settings.instagram')"
                                class="form-control  pl-5 min-h-40px @error($locale . '.instagram') is-invalid @enderror"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="email" placeholder="@lang('settings.email')"
                                class="form-control  pl-5 min-h-40px @error($locale . '.email') is-invalid @enderror"
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="phone" placeholder="@lang('settings.phone')"
                                class="form-control  pl-5 min-h-40px @error($locale . '.phone') is-invalid @enderror"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="d-block">@lang('settings.favicon')</label>
                        @if (isset($data->breadcrumb))
                            <div class="image-input-wrapper"
                                style="background-image: url({{ asset($data->breadcrumb) }}"></div>
                            <div class="image-input image-input-empty image-input-outline" id="kt_image_5"
                                style="background-image: url({{ asset($data->breadcrumb) }})">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="d-block">@lang('settings.white_logo')</label>
                        @if (isset($data->white_logo))
                            <div class="image-input-wrapper"
                                style="background-image: url({{ asset($data->white_logo) }}"></div>
                            <div class="image-input image-input-empty image-input-outline" id="kt_image_5"
                                style="background-image: url({{ asset($data->white_logo) }})">
                                <div class="image-input-wrapper"></div>
                                <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                                    data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                                    <i class="fa fa-pen icon-sm text-muted"></i>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="d-block">@lang('settings.pdf')</label>
                        <div class="image-input-wrapper" style="background-image: url({{ asset($data->pdf) }}"></div>
                        <div class="image-input image-input-empty image-input-outline" id="kt_image_5"
                            style="background-image: url({{ asset($data->pdf) }})">
                            <div class="image-input-wrapper"></div>
                            <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                                data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                                <i class="fa fa-pen icon-sm text-muted"></i>
