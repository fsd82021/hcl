...
@section('index_route', route('services.index'))
@section('store_route', route('services.store'))
...
@section('fields_content')
                    ...
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}" role="tabpanel">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="{{ $locale . '[title]' }}" placeholder="@lang('services.title')" class="form-control  pl-5 min-h-40px @error($locale . '.title') is-invalid @enderror" value="{{ old($locale . '.title') }}">
                            </div>
                        </div>
    ...
    <div class="card card-custom">
        ...
        <div class="card-footer">
            ...
            <a href="{{ route('services.index') }}" class="btn btn-light-success font-weight-bold">@lang('general.cancel')</a>
        </div>
    </div>
@endsection
